...
from tensorrt_llm.recipes import (compute_from_scenario, detect_profile,
                                   match_recipe, validate_scenario,
                                   validate_config)
...
def generate_serve_command(scenario: Dict[str, Any],
...
def print_result(scenario: Dict[str, Any],
                config: Dict[str, Any],
                env: Dict[str, str],
                cli_args: Dict[str, Any],
                output_path: str,
...
def configure(model: Optional[str],
             gpu: Optional[str],
    ...
    try:
        ...
        if recipe:
            ...
            if config_from_recipe:
                ...
                profile_name = profile or scenario.get('profile') or detect_profile(scenario.get('model', ''))
                if profile_name:
